                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class=" panel panel-primary">
                        <div class="panel-heading text-center">
                            ...
                            <h2 class="panel-title">Register Client</h2>
                        </div>
                        <div class="panel-body">
                            <div role="form">
                                <fieldset>
                                    ...
                                    <asp:Button ID="btnRegister" runat="server" CssClass="btn btn-lg btn-success btn-block" Text="Login" OnClick="btnRegister_Click" />
