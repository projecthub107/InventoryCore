<%@ Page Title="Inventory Details" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="addinventory.aspx.cs" Inherits="addinventory" %>
        ...
        <div class="col-lg-12">
            <div class="page-header">
                <h3 style="display: inline-block;">
                    <asp:Label ID="Label1" runat="server" Text="Add to Inventory"></asp:Label></h3>
