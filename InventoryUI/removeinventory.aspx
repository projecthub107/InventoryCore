<%@ Page Title="Remove Inventory" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="removeinventory.aspx.cs" Inherits="removeinventory" %>
        ...
        <div class="col-lg-12">
            <div class="page-header">
                <h3 style="display: inline-block;">
                    <asp:Label ID="lblTitle" runat="server" Text="Remove Inventory"></asp:Label></h3>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-inline">
                ...
                <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-success" Text="Remove" OnClick="btnAdd_Click" />
