...
public partial class removeinventory : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                if (Page.User.IsInRole("inv002") == false)
                {
                    // No Permission Page.
    ...
    protected void BindTransactionType(int nClientId)
    {
        ...
        var listClass = (from t in _db.TransactionTypes
                         where t.ClientId == nClientId && t.Status == 1 && t.Type == "Remove"
                         select new
                         {
    ...
    protected void GetProduct(int nClientId, int nLocationId)
    {
        ...
        if (Session["slistRemove"] != null)
        {
            listReceive = Session["slistRemove"] as List<csInventoryReceive>;
        }

        if (Session["rmvAryProductId"] != null)
        {
            aryProductId = Session["rmvAryProductId"] as List<string>;
        }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Session.Add("rmvAryProductId", aryProductId);
            Session.Add("slistRemove", listReceive);
    ...
    {
        lblResult.Text = "";
        Session["rmvAryProductId"] = null;
        Session["slistRemove"] = null;
        Reset();
        GetProduct(0, 0);
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            foreach (GridViewRow gr in grdProductList.Rows)
            {
                ...
                objPrdTrans.TransactionNumber = "RMV-" + txtTransactionNumber.Text.ToString();
    ...
    protected void ddlDefaultLocation_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("removeinventory.aspx");
    }
