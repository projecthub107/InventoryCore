<%@ Page Title="Transfer Inventory" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="transferinventory.aspx.cs" Inherits="transferinventory" %>
        ...
        <div class="col-lg-12">
            <div class="page-header">
                <h3 style="display: inline-block;">
                    <asp:Label ID="lblTitle" runat="server" Text="Transfer Inventory"></asp:Label></h3>
        ...
        <div class="col-lg-12">
            <div class="form-inline">
                ...
                <div class="form-group">
                    ...
                    <asp:Label ID="lblTransferFrom" runat="server" Font-Bold="true"></asp:Label>
                </div>
                <div class="form-group">
                    <span>To</span>
            ...
            <asp:GridView ID="grdProductList" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnRowDataBound="grdProductList_RowDataBound"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Transfer To">
                        <ItemTemplate>
                            <asp:DropDownList ID="ddlgrdTransferToLocation" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlgrdTransferToLocation_SelectedIndexChanged" AutoPostBack="true">
                            </asp:DropDownList>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="center" />
