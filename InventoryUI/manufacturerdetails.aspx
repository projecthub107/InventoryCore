<%@ Page Title="Manufacturer Details" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="manufacturerdetails.aspx.cs" Inherits="manufacturerdetails" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">
                <asp:Label ID="lblTitle" runat="server" Text="Add New Manufacturer"></asp:Label></h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <div class="row">
