...
namespace InventoryAPI.Controllers
{
    ...
    public class SP_ProductController : ControllerBase
    {
        ...
        //// To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        //[HttpPost]
        //public async Task<ActionResult<SP_Product>> PostSP_Product(SP_Product sP_Product)
        //{
        //    _context.SP_Product.Add(sP_Product);
        //    await _context.SaveChangesAsync();

        //    return CreatedAtAction("GetSP_Product", new { id = sP_Product.ProductId }, sP_Product);
        //}
